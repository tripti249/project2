...
const GopiBot = {
  ...
  respond(message) {
    ...
    if (/(evening|raat|night|sleep|neend)/.test(msg)) {
    ...
    // Fallback
    return { type: 'text', content: `Hmm, samjha nahi 🤔\nTry karein: "Mera status kya hai?" ya "Health tip do". Main hamesha yahan hoon! 🤖` };
  },
